...
const Biodata = () => {
  ...
  const handleDownload = (format: "excel" | "pdf") => {
    ...
    const fileUrl = `http://127.0.0.1:8000/download/${format}`;
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <div className="flex items-center mb-2">
              ...
              <h1 className="text-3xl font-display font-bold">Biodata Form</h1>
            </div>
            <p className="text-light_text/70 ml-4">
              Extract personal information from biodata forms efficiently and
              accurately.
            </p>
          </div>
